...
define('KO_DB_HOST', '172.18.8.133');
define('KO_DB_USER', 'mfw');
define('KO_DB_PASS', 'mfw');
define('KO_DB_NAME', 'mafengwo');
define('KO_MC_HOST', '172.18.8.131:11211');
